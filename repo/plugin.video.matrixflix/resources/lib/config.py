...
class GestionCookie:
    PathCache = 'special://userdata/addon_data/plugin.video.matrixflix'
...
class cConfig:
    ...
    # def __init__(self):
        ...
        # self.__sFileDB = os.path.join(self.__oCache,'matrixflix.db').decode('utf-8')
...
def WindowsBoxes(sTitle, siteUrl, metaType, year, sSite, sFav, sCat):
    ...
    # Sinon on gere par matrixflix via la lib TMDB
    ...
    try:
        ...
        DIALOG.VSok("Please clear metadata cache Setting - tools - 'clear matrixflix cache'")
        pass
    ...
    class XMLDialog(xbmcgui.WindowXMLDialog):
        ...
        def onClick(self, controlId):
            if controlId == 11:
                ...
                self.setProperty('matrixflix_menu', 'Person')
